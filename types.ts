...
export type UserClassification = 'director' | 'Director' | 'asesor' | 'Asesor' | 'realizador' | 'Realizador de sonido' | 'locutor' | 'Locutor' | 'guionista' | 'Guionista' | 'periodista' | 'Periodista' | 'coordinador' | 'Coordinador' | 'director de emisora' | 'Director de la emisora' | 'jefe de programación' | 'Jefe de Programación' | 'especialista' | 'Especialista' | 'Especialista en Comunicación' | 'especialista en comunicación' | 'Especialista en Gestión de Contenido' | 'especialista en gestión de contenido' | 'auxiliar general' | 'asistente de dirección' | 'recepcionista' | 'Administrador' | 'Trabajador' | 'Usuario' | 'Directora';
